...
const pm = __nccwpck_require__(3179);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
var GetIntrinsic = __nccwpck_require__(1433);

var callBind = __nccwpck_require__(7517);
...
var bind = __nccwpck_require__(4320);
var GetIntrinsic = __nccwpck_require__(1433);
...
module.exports = __nccwpck_require__(1843)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(6193);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	...
	module.exports = __nccwpck_require__(8519);
}
...
try {
	...
	const supportsColor = __nccwpck_require__(7171);
...
var util = __nccwpck_require__(3837),
    ...
    File = __nccwpck_require__(9933),
    MultipartParser = (__nccwpck_require__(5840).MultipartParser),
    QuerystringParser = (__nccwpck_require__(9823)/* .QuerystringParser */ .l),
    OctetParser       = (__nccwpck_require__(2113)/* .OctetParser */ .h),
    JSONParser = (__nccwpck_require__(8729)/* .JSONParser */ .c),
...
var IncomingForm = (__nccwpck_require__(9492)/* .IncomingForm */ .c);
...
var implementation = __nccwpck_require__(9135);
...
var hasSymbols = __nccwpck_require__(6690)();
...
var bind = __nccwpck_require__(4320);
var hasOwn = __nccwpck_require__(2916);
...
var hasSymbolSham = __nccwpck_require__(813);
...
const Yallist = __nccwpck_require__(197)
...
let Mime = __nccwpck_require__(7293);
module.exports = new Mime(__nccwpck_require__(1150), __nccwpck_require__(4482));
...
var inspectCustom = (__nccwpck_require__(4330).custom);
...
var stringify = __nccwpck_require__(8400);
var parse = __nccwpck_require__(1026);
var formats = __nccwpck_require__(5332);
...
var utils = __nccwpck_require__(3050);
...
var getSideChannel = __nccwpck_require__(2021);
var utils = __nccwpck_require__(3050);
var formats = __nccwpck_require__(5332);
var has = Object.prototype.hasOwnProperty;
...
const parseOptions = __nccwpck_require__(1213)
const {re, t} = __nccwpck_require__(6607)
const cmp = __nccwpck_require__(7434)
const debug = __nccwpck_require__(7437)
const SemVer = __nccwpck_require__(6333)
const Range = __nccwpck_require__(4137)
...
const LRU = __nccwpck_require__(1151)
const cache = new LRU({ max: 1000 })

const parseOptions = __nccwpck_require__(1213)
const Comparator = __nccwpck_require__(121)
const debug = __nccwpck_require__(7437)
const SemVer = __nccwpck_require__(6333)
const {
  re,
...
const debug = __nccwpck_require__(7437)
const { MAX_LENGTH, MAX_SAFE_INTEGER } = __nccwpck_require__(4054)
const { re, t } = __nccwpck_require__(6607)

const parseOptions = __nccwpck_require__(1213)
const { compareIdentifiers } = __nccwpck_require__(2505)
class SemVer {
...
const parse = __nccwpck_require__(9622)
...
const eq = __nccwpck_require__(3813)
const neq = __nccwpck_require__(7410)
const gt = __nccwpck_require__(4923)
const gte = __nccwpck_require__(114)
const lt = __nccwpck_require__(4140)
const lte = __nccwpck_require__(8565)
...
const compare = __nccwpck_require__(5491)
...
const {MAX_LENGTH} = __nccwpck_require__(4054)
const { re, t } = __nccwpck_require__(6607)
const SemVer = __nccwpck_require__(6333)
...
const compareBuild = __nccwpck_require__(2540)
...
const internalRe = __nccwpck_require__(6607)
module.exports = {
  re: internalRe.re,
  src: internalRe.src,
  tokens: internalRe.t,
  SEMVER_SPEC_VERSION: (__nccwpck_require__(4054).SEMVER_SPEC_VERSION),
  SemVer: __nccwpck_require__(6333),
  compareIdentifiers: (__nccwpck_require__(2505).compareIdentifiers),
  rcompareIdentifiers: (__nccwpck_require__(2505).rcompareIdentifiers),
  parse: __nccwpck_require__(9622),
  valid: __nccwpck_require__(6727),
  clean: __nccwpck_require__(4989),
  inc: __nccwpck_require__(7213),
  diff: __nccwpck_require__(9184),
  major: __nccwpck_require__(3952),
  minor: __nccwpck_require__(5252),
  patch: __nccwpck_require__(1714),
  prerelease: __nccwpck_require__(9330),
  compare: __nccwpck_require__(5491),
  rcompare: __nccwpck_require__(3854),
  compareLoose: __nccwpck_require__(6550),
  compareBuild: __nccwpck_require__(2540),
  sort: __nccwpck_require__(4798),
  rsort: __nccwpck_require__(4279),
  gt: __nccwpck_require__(4923),
  lt: __nccwpck_require__(4140),
  eq: __nccwpck_require__(3813),
  neq: __nccwpck_require__(7410),
  gte: __nccwpck_require__(114),
  lte: __nccwpck_require__(8565),
  cmp: __nccwpck_require__(7434),
  coerce: __nccwpck_require__(7622),
  Comparator: __nccwpck_require__(121),
  Range: __nccwpck_require__(4137),
  satisfies: __nccwpck_require__(8562),
  toComparators: __nccwpck_require__(7842),
  maxSatisfying: __nccwpck_require__(4755),
  minSatisfying: __nccwpck_require__(7071),
  minVersion: __nccwpck_require__(2716),
  validRange: __nccwpck_require__(574),
  outside: __nccwpck_require__(1813),
  gtr: __nccwpck_require__(9273),
  ltr: __nccwpck_require__(1849),
  intersects: __nccwpck_require__(689),
  simplifyRange: __nccwpck_require__(1635),
  subset: __nccwpck_require__(5812),
}
...
const { MAX_SAFE_COMPONENT_LENGTH } = __nccwpck_require__(4054)
const debug = __nccwpck_require__(7437)
...
const outside = __nccwpck_require__(1813)
...
const Range = __nccwpck_require__(4137)
const satisfies = __nccwpck_require__(8562)
const gt = __nccwpck_require__(4923)
const lt = __nccwpck_require__(4140)
const lte = __nccwpck_require__(8565)
const gte = __nccwpck_require__(114)
...
var GetIntrinsic = __nccwpck_require__(1433);
var callBound = __nccwpck_require__(3033);
var inspect = __nccwpck_require__(1487);
...
var _require2 = __nccwpck_require__(3904),
    CookieJar = _require2.CookieJar;

var _require3 = __nccwpck_require__(3904),
    CookieAccessInfo = _require3.CookieAccessInfo;

var methods = __nccwpck_require__(7015);

var request = __nccwpck_require__(9070);

var AgentBase = __nccwpck_require__(23);
/**
 * Expose `Agent`.
 */
...
var semver = __nccwpck_require__(4093);
...
var qs = __nccwpck_require__(4294);

var mime = __nccwpck_require__(2528);

var methods = __nccwpck_require__(7015);

var FormData = __nccwpck_require__(5899);

var formidable = __nccwpck_require__(2301);

var debug = __nccwpck_require__(7662)('superagent');

var CookieJar = __nccwpck_require__(3904);

var semver = __nccwpck_require__(4093);

var safeStringify = __nccwpck_require__(2245);

var utils = __nccwpck_require__(2329);

var RequestBase = __nccwpck_require__(9320);

var _require2 = __nccwpck_require__(5989),
    unzip = _require2.unzip;

var Response = __nccwpck_require__(2944);

var http2;
if (semver.gte(process.version, 'v10.10.0')) http2 = __nccwpck_require__(802);
...
exports.agent = __nccwpck_require__(8835);
/**
 * Noop.
 */
...
exports.parse = __nccwpck_require__(7270);
/**
...
exports["application/x-www-form-urlencoded"] = __nccwpck_require__(5847);
exports["application/json"] = __nccwpck_require__(6259);
exports.text = __nccwpck_require__(8771);

var binary = __nccwpck_require__(2200);
...
var ResponseBase = __nccwpck_require__(1375);
/**
 * Expose `Response`.
 */
 ...
 */
var isObject = __nccwpck_require__(8180);
/**
 * Expose `RequestBase`.
 */
...
try {
  ...
  __nccwpck_require__(9594)(Yallist)
} catch (er) {}
...
var appConfig_1 = __nccwpck_require__(5164);
var auth_1 = __importDefault(__nccwpck_require__(5857));
var Command = /** @class */ (function () {
    function Command() {
        var _a;
        this.credentials = (0, auth_1.default)();
        this.projectPath = (_a = appConfig_1.appConfig.projectPath) !== null && _a !== void 0 ? _a : '';
    }
    return Command;
}());
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var bot_1 = __importDefault(__nccwpck_require__(7037));
var Command_1 = __nccwpck_require__(9150);
var Validate = /** @class */ (function (_super) {
    ...
    Validate.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var bot, res, errorsMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bot = bot_1.default.readManifest(this.projectPath);
                        return [4 /*yield*/, bot_1.default.validateBot(bot, this.credentials)];
                    case 1:
                        res = _a.sent();
                        if (res.valid)
                            return [2 /*return*/, console.log('Bot is valid CSML!')];
                        console.error('\nThere are errors in your bot:');
                        errorsMessage = [];
                        res.errors.forEach(function (e) {
                            var message = "Flow ".concat(e.flow, ", step ").concat(e.step, ", line ").concat(e.line, ", col ").concat(e.col, ": ").concat(e.message);
...
var core = __nccwpck_require__(2719);
exports.appConfig = {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var crypto_1 = __importDefault(__nccwpck_require__(6113));
var appConfig_1 = __nccwpck_require__(5164);
/**
 ...
 */
function auth() {
    var key = appConfig_1.appConfig.apiKey;
    var secret = appConfig_1.appConfig.apiSecret;
    if (!key)
        throw new Error('Missing CSML Studio API key. Visit https://studio.csml.dev to generate your credentials.');
    if (!secret)
        throw new Error('Missing CSML Studio API secret. Visit https://studio.csml.dev to generate your credentials.');
    var UNIX_TIMESTAMP = Math.floor(Date.now() / 1000);
    var XApiKey = "".concat(key, "|").concat(UNIX_TIMESTAMP);
    var signature = crypto_1.default
        .createHmac('sha256', secret)
        .update(XApiKey, 'utf-8')
        .digest('hex');
    var XApiSignature = "sha256=".concat(signature);
    return {
        'x-api-key': XApiKey,
...
var lodash_pick_1 = __importDefault(__nccwpck_require__(7822));
var lodash_uniq_1 = __importDefault(__nccwpck_require__(4515));
var request_1 = __importDefault(__nccwpck_require__(6753));
var BotHelpers = /** @class */ (function () {
    function BotHelpers() {
    }
    /**
     ...
     * @param {*} projectPath
     */
    BotHelpers.readManifest = function (projectPath) {
        try {
            var data = fs_1.default
                .readFileSync(path_1.default.join(projectPath, './bot.json'))
                .toString();
            var rawManifest_1 = JSON.parse(data);
            var formatted = (0, lodash_pick_1.default)(rawManifest_1, [
                'id',
                'name',
                'description',
                'default_flow',
            ...
            var flowFiles = fs_1.default.readdirSync(path_1.default.join(projectPath, './flows'));
            // work on a copy of the raw flows as they will be modified
            var localFlowsHashmap_1 = flowFiles.reduce(function (acc, filename) {
                // ignore invalid files
                var isCommands = filename.endsWith('.cmds.csml');
                var isContent = !isCommands && filename.endsWith('.csml');
                if (!isCommands && !isContent)
                    return acc;
                var flowName = filename.split('.')[0];
                var content = fs_1.default
                    .readFileSync(path_1.default.join(projectPath, './flows', filename))
                    .toString();
                ...
                if (isContent)
                    acc[flowName].content = content;
                else if (isCommands)
                    acc[flowName].commands = (0, lodash_uniq_1.default)(content.split('\n')).filter(function (c) { return !!c.trim(); });
                return acc;
            }, {});
            formatted.airules = flowFiles
                .filter(function (filename) { return filename.endsWith('.cmds.csml'); })
                .reduce(function (acc, filename) {
                var commands = fs_1.default
                    .readFileSync(path_1.default.join(projectPath, './flows', filename))
                    .toString()
                    .split('\n')
                    .map(function (l) { return l.trim(); })
                    // only keep lines that exist and that are not "/flowname"
                    .filter(function (l) { return l && "".concat(l, ".cmds.csml") !== "/".concat(filename); });
                var target = {
                    flow_name: filename.split('.')[0],
                };
                // don't send commands for flows that don't have any
                if (commands.length)
                    acc.push({ commands: commands, target: target });
                return acc;
            }, []);
            // flows are an array of valid flow objects
            formatted.flows = Object.keys(localFlowsHashmap_1).map(function (k) { return localFlowsHashmap_1[k]; });
            // default_flow must point to an existing flow
            var defFlow = formatted.flows.find(function (lf) { return lf.id === rawManifest_1.default_flow; });
            if (!defFlow)
                throw new Error("Bot's default_flow does not exist in project");
            return formatted;
        }
        catch (err) {
            throw new Error("Invalid bot manifest at ".concat(projectPath, ": ").concat(err.message));
        }
    };
    /**
     ...
     */
    BotHelpers.writeManifest = function (manifest, dir) {
        var data = (0, lodash_pick_1.default)(manifest, ['name', 'description', 'default_flow']);
        var defFlow = manifest.flows.find(function (f) { return f.id === manifest.default_flow; });
        if (!defFlow)
            throw new Error('Invalid bot manifest: default flow does not exist');
        data.default_flow = defFlow.name;
        fs_1.default.writeFileSync(path_1.default.join(dir, './bot.json'), JSON.stringify(data, null, 2));
        manifest.flows.forEach(function (f) {
            fs_1.default.writeFileSync(path_1.default.join(dir, 'flows', "".concat(f.name, ".csml")), f.content);
            fs_1.default.writeFileSync(path_1.default.join(dir, 'flows', "".concat(f.name, ".cmds.csml")), (0, lodash_uniq_1.default)(f.commands)
     ...
     * @param {*} credentials
     */
    BotHelpers.getFromStudio = function (credentials) {
        return __awaiter(this, void 0, void 0, function () {
            var body, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, request_1.default.get('/bot').set(credentials)];
                    case 1:
                        body = (_a.sent()).body;
                        return [2 /*return*/, body];
                    case 2:
                        err_1 = _a.sent();
                        throw new Error("Impossible to retrieve bot: ".concat(err_1.message));
     ...
     * @param {*} credentials
     */
    BotHelpers.updateStudioBot = function (bot, credentials) {
        return __awaiter(this, void 0, void 0, function () {
            var toUpdate, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        toUpdate = (0, lodash_pick_1.default)(bot, ['default_flow', 'name']);
                        return [4 /*yield*/, request_1.default.put('/bot').set(credentials).send(toUpdate)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        err_2 = _a.sent();
                        throw new Error("Impossible to update bot: ".concat(err_2.message));
                    case 3: return [2 /*return*/];
                }
            });
        });
     ...
     * @param {*} filepath
     */
    BotHelpers.validateBot = function (bot, credentials) {
        return __awaiter(this, void 0, void 0, function () {
            var body, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_3 = _a.sent();
                        throw new Error("Impossible to validate bot: ".concat(err_3.message));
                    case 3: return [2 /*return*/];
                }
            });
        });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var Validate_1 = __importDefault(__nccwpck_require__(98));
var core = __importStar(__nccwpck_require__(2719));
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            new Validate_1.default().run();
        }
        catch (error) {
...
var appConfig_1 = __nccwpck_require__(5164);
var request = __nccwpck_require__(9070);
var prefix = __nccwpck_require__(5232);
exports["default"] = request
    .agent()
    .use(prefix(appConfig_1.appConfig.studio.endpoint))
    .accept('application/json')
    .set('Content-Type', 'application/json')
    .on('error', function (err) {
    var message = err.response.text;
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(1995);
